package com.pumpkin.mvvm.widget
...
import com.pumpkin.mvvm.util.superReduce
...
constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
     ...
     * @param isImmediatelyShow 是否需要直接展示
     */
    fun addViewByViewState(view: View, state: ViewState, isImmediatelyShow: Boolean = false) {
