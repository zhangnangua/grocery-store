...
public class RegionLorePage {
	...
	public static DocumentPage pageForDoc( Document doc ){
		switch (doc){
			case SEWERS_GUARD: default:     return new Sewers();
			case PRISON_WARDEN:             return new Prison();
			case CAVES_EXPLORER:            return new Caves();
			case CITY_WARLOCK:              return new City();
			case HALLS_KING:                return new Halls();
		}
	}
